!(function (t, e, i, s) {
    ...
    (o.prototype = {
      setSelectedDate: function (t, e) {
        this._setSelectedDate(
          moment(t, e ? e : this.options.selectedDateFormat)
        ),
          this._render();
      },
      remove: function () {
      ...
      _subscribeEvents: function () {
        this._unsubscribeEvents(),
          this.$element.on("click", t.proxy(this._clickedHandler, this)),
          ...
          this.options.fillWidth &&
            t(e).on("resize", t.proxy(this._resize, this));
      },
      _destroy: function () {
        this.initialized &&
      ...
      _clickedHandler: function (e) {
        ...
        var i = t(e.target),
          s = i.attr("class");
        -1 != s.indexOf("dp-nav-left")
          ? this._back()
          : -1 != s.indexOf("dp-nav-right")
          ? this._forward()
          : -1 != s.indexOf("dp-item") && this._select(i.attr("data-moment"));
      },
      _setSelectedDate: function (t) {
        t.isSame(this.options.selectedDate) ||
          t.isBefore(this.options.startDate) ||
          t.isAfter(this.options.endDate) ||
          ((this.options.selectedDate = t.startOf("day")),
          this.$element.trigger("selectedDateChanged", [t.clone()]));
      },
      _back: function () {
        this._setSelectedDate(
      ...
      _select: function (t) {
        this._setSelectedDate(moment(t, this.options.selectedDateFormat)),
          this._render();
      },
      ...
      _render: function () {
        ...
        this.initialized
          ...
          : (this.$element
            ...
            (this.$wrapper = t(this._template.list)),
            (this.$leftNav = t(this._template.navItem)
              ...
              .append(
                t(this._template.icon)
                  .addClass("ri-arrow-left-s-line fs-4")
                  .addClass("dp-nav-left")
              )
              .width(this.options.navItemWidth)),
            (this.$rightNav = t(this._template.navItem)
              ...
              .append(
                t(this._template.icon)
                  .addClass("ri-arrow-right-s-line fs-4")
                  .addClass("dp-nav-right")
              )
              .width(this.options.navItemWidth)),
            (this.$calendar = this.options.showCalendar
              ? t(this._template.calendar)
              : s),
            this._injectStyle(),
            (this.initialized = !0));
        ...
        this.$element.empty().append(this.$wrapper.empty()),
          ...
          i.isSelectedStartDate &&
            this.$leftNav
              .addClass("dp-no-select")
              .attr("title", "Start of valid date range"),
          this.$wrapper.append(t(e._template.listItem).append(this.$leftNav)),
          t.each(i.items, function (i, s) {
            var a = t(e._template.dateItem)
              .attr("data-moment", s.m)
              .attr("title", s.hint)
              .width(s.itemWidth);
            s.isSelected &&
              e.options.highlightSelectedDate &&
              a.addClass("dp-selected"),
              s.isToday && e.options.highlightToday && a.addClass("dp-today"),
              s.isStartOfWeek &&
                e.options.showStartOfWeek &&
                a.addClass("dp-divider"),
              s.isOffDay && e.options.showOffDays && a.addClass("dp-off"),
              s.isSelected && e.options.showCalendar && a.append(e.$calendar),
              "sm" === e.options.size
                ? a.addClass("dp-item-sm")
                : "lg" === e.options.size && a.addClass("dp-item-lg"),
              s.isValid || a.addClass("dp-no-select"),
              a.append(s.text),
              e.$wrapper.append(t(e._template.listItem).append(a));
          }),
          ...
          this.$wrapper.append(t(e._template.listItem).append(this.$rightNav)),
          this.$calendar &&
            (this.$calendar
              .datepicker({
                autoclose: !0,
            ...
            this.$calendar.on(
              "changeDate",
              t.proxy(this._calendarSelect, this)
            ));
      },
      _injectStyle: function () {
        this.options.injectStyle &&
          !i.getElementById("bootstrap-datepaginator-style") &&
          t(
      ...
      _buildData: function () {
        for (
          var t =
            ...
            e = Math.floor(t / this.options.itemWidth),
            i = parseInt(e / 2),
            s = Math.floor(t / e),
            a = Math.floor(this.options.selectedItemWidth + (t - e * s)),
            o = moment().startOf("day"),
            n = this.options.selectedDate.clone().subtract("days", i),
            d = this.options.selectedDate.clone().add("days", e - i),
            p = {
          ...
          var h =
            (r.isSame(this.options.startDate) ||
              r.isAfter(this.options.startDate)) &&
            (r.isSame(this.options.endDate) || r.isBefore(this.options.endDate))
              ? !0
              : !1;
          p.items[p.items.length] = {
            ...
            isOffDay:
              ...
              this.options.offDays
                .split(",")
                .indexOf(r.format(this.options.offDaysFormat))
                ? !0
                : !1,
            isStartOfWeek:
              -1 !==
              this.options.startOfWeek
                .split(",")
                .indexOf(r.format(this.options.startOfWeekFormat))
                ? !0
                : !1,
            text: r.format(
              r.isSame(this.options.selectedDate)
                ? this.options.textSelected
                : this.options.text
            ),
      ...
      _template: {
        ...
        calendar: '<i id="dp-calendar" class="ti-calendar"></i>',
      },
  ...
  t.fn[a] = function (e, i) {
    return this.each(function () {
      ...
      "string" == typeof e
        ? s
          ? t.isFunction(s[e]) && "_" !== e.charAt(0)
            ? ("string" == typeof i && (i = [i]), s[e].apply(s, i))
            : n("No such method : " + e)
          : n("Not initialized, can not call method : " + e)
        : s
        ? s._init(e)
        : t.data(this, "plugin_" + a, new o(this, e));
    });
  };
