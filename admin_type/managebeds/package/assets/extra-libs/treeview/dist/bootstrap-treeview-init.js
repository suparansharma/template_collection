$(function () {
  ...
  $("#treeview1").treeview({
    ...
    expandIcon: "ri-add-line fs-4 me-1",
    collapseIcon: "ri-subtract-line fs-4 me-1",
    nodeIcon: "ri-folder-5-line fs-4 me-1",
    data: defaultData,
  });
  ...
  $("#treeview5").treeview({
    ...
    nodeIcon: "ri-file-list-line fs-4 me-1",
    data: defaultData,
  });
  ...
  $("#treeview6").treeview({
    selectedBackColor: "#03a9f3",
    onhoverColor: "rgba(0, 0, 0, 0.05)",
    expandIcon: "ri-checkbox-blank-circle-fill fs-4 me-1",
    collapseIcon: "ri-checkbox-blank-circle-line fs-4 me-1",
    nodeIcon: "ri-user-3-line fs-4 me-1",
    showTags: true,
    data: defaultData,
  });
