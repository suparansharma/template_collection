!(function (l) {
  ...
  var i,
    ...
    y = function (e, t) {
      return (function (e, t) {
        for (
          var n = t !== undefined && null !== t ? t : b, r = 0;
    ...
    _ = function (e, n) {
      ...
      function t(e, t) {
        r.parentNode && r.parentNode.removeChild(r), n({ width: e, height: t });
      }
      (r.onload = function () {
      ...
      return (function n(e, r) {
        return (
          ...
          C.each(e, function (e) {
            ...
            e.menu ? (t.menu = n(e.menu)) : ((t.value = e.value), a(t)),
              r.push(t);
          }),
          r
        );
    ...
    O = function (e, t, n) {
      ...
      (n.onload = function () {
        t.width ||
          t.height ||
          !d(e) ||
          e.dom.setAttribs(n, { width: n.clientWidth, height: n.clientHeight }),
          r();
      }),
        (n.onerror = r);
    },
    ...
    E =
      ...
      function () {
        ...
        for (var n = {}, r = 0; r < e.length; r++) {
          var a = e[r];
          for (var o in a) U.call(a, o) && (n[o] = i(n[o], a[o]));
        }
        return n;
      }),
    k = P.DOM,
    ...
    W = function (e) {
      var t, n, r, a;
      j(e)
        ? ((a = (r = e).parentNode), k.insertAfter(r, a), k.remove(a))
        : ((t = e),
          (n = k.create("figure", { class: "image" })),
          k.insertAfter(n, t),
          n.appendChild(t),
          n.appendChild(
            k.create("figcaption", { contentEditable: !0 }, "Caption")
          ),
    ...
    Y = function (e, t) {
      ...
      return (
        F(n, "style", t.style),
        (M(n) || "" !== t.hspace) && $(n, t.hspace),
        (D(n) || "" !== t.vspace) && X(n, t.vspace),
        (z(n) || "" !== t.border) && q(n, t.border),
        (H(n, "borderStyle") || "" !== t.borderStyle) && K(n, t.borderStyle),
    ...
    ne = function (e, t, n) {
      ...
      ee(n, r, t, "caption", function (e, t, n) {
        ...
        ee(n, r, t, "alt", F),
        ee(n, r, t, "title", F),
        ee(n, r, t, "width", V(0, e)),
        ee(n, r, t, "height", V(0, e)),
        ee(n, r, t, "class", F),
        ee(
          n,
          r,
        ...
        ee(n, r, t, "vspace", te(X, e)),
        ee(n, r, t, "border", te(q, e)),
        ee(n, r, t, "borderStyle", te(K, e));
    },
    re = function (e, t) {
    ...
    le = function (t, e) {
      var n = (function (e, t) {
        var n = l.document.createElement("img");
        if ((ne(e, E(t, { caption: !1 }), n), F(n, "alt", t.alt), t.caption)) {
          var r = k.create("figure", { class: "image" });
          return (
            r.appendChild(n),
            r.appendChild(
              k.create("figcaption", { contentEditable: !0 }, "Caption")
            ...
            onchange:
              ...
              function (e) {
                ...
                if (u(o)) {
                  ...
                  n.find("#vspace").value(""),
                    n.find("#hspace").value(""),
                    (((a = I(a))["margin-top"] && a["margin-bottom"]) ||
                      (a["margin-right"] && a["margin-left"])) &&
                      (a["margin-top"] === a["margin-bottom"]
                        ? n.find("#vspace").value(A(a["margin-top"]))
                        : n.find("#vspace").value(""),
                      a["margin-right"] === a["margin-left"]
                        ? n.find("#hspace").value(A(a["margin-right"]))
                        : n.find("#hspace").value("")),
                    a["border-width"]
                      ? n.find("#border").value(A(a["border-width"]))
                      : n.find("#border").value(""),
                    a["border-style"]
                      ? n.find("#borderStyle").value(a["border-style"])
                      : n.find("#borderStyle").value(""),
                    n
                      .find("#style")
                      .value(
                        t.serializeStyle(t.parseStyle(t.serializeStyle(a)))
                      );
                }
              }),
          },
    ...
    ge = function (e, t, n) {
      ...
      n &&
        ...
        i &&
        (o !== r
          ? ((i = Math.round((o / r) * i)), isNaN(i) || t.value(i))
          : ((o = Math.round((i / a) * o)), isNaN(o) || e.value(o))),
        de(e, t);
    },
    fe = function (e) {
      me(e, ge);
    ...
    ye = function (s, e) {
      var t = [
        {
          ...
          onchange: function (e) {
            ...
            (n = s),
              ...
              (l = t.control),
              (u = l.rootControl),
              (c = u.find("#image-list")[0]) &&
                c.value(n.convertURL(l.value(), "src")),
              C.each(i, function (e, t) {
                u.find("#" + t).value(e);
              }),
              i.width ||
                i.height ||
                ((r = n.convertURL(l.value(), "src")),
                (a = m(n)),
                (o = new RegExp("^(?:[a-z]+:)?//", "i")),
                a &&
                  !o.test(r) &&
                  r.substring(0, a.length) !== a &&
                  (r = a + r),
                l.value(r),
                _(n.documentBaseURI.toAbsolute(l.value()), function (e) {
                  e.width &&
                    e.height &&
                    d(n) &&
                    (u.find("#width").value(e.width),
                    u.find("#height").value(e.height),
                    he(u));
                }));
          },
          onbeforecall: be,
      ...
      return (
        r(s) &&
          t.push({ name: "alt", type: "textbox", label: "Image description" }),
        a(s) &&
          t.push({ name: "title", type: "textbox", label: "Image Title" }),
        d(s) && t.push(pe()),
        n(s) &&
          t.push({
            name: "class",
        ...
        o(s) && t.push({ name: "caption", type: "checkbox", label: "Caption" }),
        t
      );
    },
    xe = function (e, t) {
      return { title: "General", type: "form", items: ye(e, t) };
    },
    we = ye,
    Ce = function () {
  ...
  function Ae(i) {
    var t = function (e, r, a, t) {
      var o, n;
      (o = new (x.getOrDie("XMLHttpRequest"))()).open("POST", i.url),
        ...
        (n = new l.FormData()).append("file", e.blob(), e.filename()),
        o.send(n);
    };
    return (
      (i = C.extend({ credentials: !1, handler: t }, i)),
      {
        upload: function (e) {
          return i.url || i.handler !== t
            ? ((r = e),
              (a = i.handler),
              new w(function (e, t) {
                try {
          ...
          L(a)
            .then(function (e) {
              ...
              return i.upload(t).then(function (e) {
                ...
                return (
                  t.value(e),
                  n.find("tabpanel")[0].activateTab(0),
                  t.fire("change"),
                  l(),
                  e
                );
          ...
          (t = {
            ...
            onselect: function (e) {
              ...
              (!t.value() ||
                ...
                n.find("#src").value(e.control.value()).fire("change");
            },
      ...
      return function (e) {
        for (
          ...
          (t = e[r]),
            (n = t.attr("class")) &&
              /\bimage\b/.test(n) &&
              (t.attr("contenteditable", o ? "false" : null),
              C.each(t.getAll("figcaption"), a));
      };
    },
    Me = function (e) {
      e.on("preInit", function () {
        e.parser.addNodeFilter("figure", ke(!0)),
          e.serializer.addNodeFilter("figure", ke(!1));
      });
    },
    De = function (e) {
      e.addButton("image", {
