        ...
        (n = function (t) {
          ...
          function b(r, i, n, a, s, o) {
            ...
            var l,
              ...
              b = {};
            if (a)
              for (w = 0, B = Me.length; w < B; w++) {
                var _ = Me[w];
                if (_.el.id == i.id && _.anim == r) {
                  _.percent != n ? (Me.splice(w, 1), (u = 1)) : (h = _),
                    ...
                    switch (
                      ...
                      case "path":
                        ...
                        for (
                          ...
                          b[C][w] = [0];
                          for (var N = 1, E = v[C][w].length; N < E; N++)
                            b[C][w][N] = (M[w][N] - v[C][w][N]) / x;
                        }
                        break;
                      case "transform":
                        var L = i._,
                        ...
                        if (F)
                          for (
                            ...
                            for (
                              b[C][w] = [v[C][w][0]], N = 1, E = v[C][w].length;
                              N < E;
                              N++
                            )
          ...
          if (
            ...
            var Et = A.doc.createElement("div"),
              Lt;
            if (
              ((Et.innerHTML = '<v:shape adj="1"/>'),
              (Lt = Et.firstChild),
          ...
          (e.svg = !(e.vml = "VML" == e.type)),
            (e._Paper = N),
            (e.fn = E = N.prototype = e.prototype),
            (e._id = 0),
            (e.is = function (t, e) {
              return (
                (e = O.call(e)),
            ...
            Ut = function (t, e, r, i, a, s, o, l, h, u) {
              ...
              if (H(A) > c) {
                ...
                (T = S + c * (o && T > S ? 1 : -1)),
                  (l = B + r * W.cos(T)),
                  (h = C + i * W.sin(T)),
                  (p = Ut(l, h, r, i, a, 0, o, N, E, [T, M, B, C]));
              }
              A = T - S;
              var L = W.cos(S),
                F = W.sin(S),
          ...
          (ye.drag = function (r, i, n, a, s, o) {
            ...
            (E.setSize = function (t, r) {
              return e._engine.setSize.call(this, t, r);
            }),
            (E.setViewBox = function (t, r, i, n, a) {
          ...
          (E.getElementByPoint = function (t, e) {
            ...
            (E.getElementsByBBox = function (t) {
              var r = this.set();
              return (
            ...
            (E.getElementsByPoint = function (t, e) {
              var r = this.set();
              return (
                this.forEach(function (i) {
            ...
            (ye.getBBox = function (t) {
              ...
              return t
                ? ((!e.dirty && e.bboxwt) ||
                    ((this.realPath = Mt[this.type](this)),
                ...
                : ((e.dirty || e.dirtyT || !e.bbox) &&
                    ((!e.dirty && this.realPath) ||
                      ((e.bboxwt = 0), (this.realPath = Mt[this.type](this))),
            ...
            (ye.glow = function (t) {
              ...
              var e = {
                ...
                i = this.paper,
                n = i.set(),
                a = this.realPath || Mt[this.type](this);
          ...
          var Me = [],
            ...
            Ee = function () {
              for (var r = +new Date(), i = 0; i < Me.length; i++) {
                var n = Me[i];
          ...
          (ye.animateWith = function (t, r, i, n, a, s) {
            ...
            for (var c = 0, f = Me.length; c < f; c++)
              if (Me[c].anim == r && Me[c].el == t) {
                Me[f - 1].start = Me[c].start;
                break;
              }
            return o;
          }),
            ...
            (ye.status = function (t, e) {
              ...
              for (n = Me.length; i < n; i++)
                if (((a = Me[i]), a.el.id == this.id && (!t || a.anim == t))) {
            ...
            (ye.pause = function (e) {
              for (var r = 0; r < Me.length; r++)
                Me[r].el.id != this.id ||
                  (e && Me[r].anim != e) ||
                  (t("raphael.anim.pause." + this.id, this, Me[r].anim) !==
                    !1 &&
                    (Me[r].paused = !0));
              return this;
            }),
            (ye.resume = function (e) {
              for (var r = 0; r < Me.length; r++)
                if (Me[r].el.id == this.id && (!e || Me[r].anim == e)) {
                  var i = Me[r];
            ...
            (ye.stop = function (e) {
              for (var r = 0; r < Me.length; r++)
                Me[r].el.id != this.id ||
                  (e && Me[r].anim != e) ||
                  (t("raphael.anim.stop." + this.id, this, Me[r].anim) !== !1 &&
                    Me.splice(r--, 1));
              return this;
            }),
          ...
          return (
            ...
            (E.print = function (t, r, i, n, a, s, o, l) {
              (s = s || "middle"),
                (o = Y(G(o || 0, 1), -1)),
                (l = Y(G(l || 1, 3), 1));
              var h = q(i)[I](R),
                ...
                if ("path" == i.type) {
                  ...
                  if (
                    ...
                    var A = t._g.doc.getElementById(T),
                      M;
                    A
                      ? (g[T]++, (M = A.getElementsByTagName("use")[0]))
                      : ((A = x(x("marker"), {
                          id: T,
                          markerHeight: B,
                          markerWidth: k,
                  ...
                  for (w in g)
                    if (g[e](w) && !g[w]) {
                      var E = t._g.doc.getElementById(w);
            ...
            var S = function (t, e, i) {
              ...
              A = function (e, a, s) {
                ...
                if (((e = e.shape || e.node), x.length)) {
                  ...
                  for (var v = [], y = 0, m = x.length; y < m; y++)
