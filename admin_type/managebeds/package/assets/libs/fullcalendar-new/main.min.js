...
var FullCalendar = (function (e) {
  ...
  function yr(e, t) {
    return (
      void 0 === t && (t = "day"), JSON.stringify({ date: rt(e), type: t })
    );
  }
  var Er,
    Sr = null;
  ...
  function yo() {
    ...
    return function (r, o) {
      return (
        (t && Ve(t, o) && r === e) || ((e = r), (t = o), (n = Eo(r, o))), n
      );
    };
  }
  function Eo(e, t) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        for (
          ...
          d.push(this.renderSection(e, c, s)), (c += 1);
        for (; c < u && "body" === (e = i[c]).type; )
          p.push(this.renderSection(e, c, s)), (c += 1);
        for (; c < u && "footer" === (e = i[c]).type; )
          f.push(this.renderSection(e, c, s)), (c += 1);
        var h = !pr();
        return Ar(
          "table",
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            u = n.navLinks
              ? { "data-navlink": yr(a, "week"), tabIndex: 0 }
              : {};
          return Ar(
            ca,
            {
