            ...
            if (
              ...
              if (a.globals.zoomEnabled) {
                ...
                if (
                  ((a.globals.zoomed = !0),
                  a.globals.zoomed ||
                    ((a.globals.lastXAxis = f.clone(a.config.xaxis)),
                    (a.globals.lastYAxis = f.clone(a.config.yaxis))),
                  a.config.xaxis.convertedCatToNumeric &&
                    ((h = Math.floor(h)),
                    (c = Math.floor(c)),
                ...
                if (n) {
                  ...
                  b &&
                    ((p = b.xaxis ? b.xaxis : p), (u = b.yaxis ? b.yaxe : u));
                }
                var m = { xaxis: p };
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            for (var g = 0; g < t.length; g++) {
              ...
              if (
                (y.attr({ index: 0, j: g }), i.config.chart.dropShadow.enabled)
              ) {
