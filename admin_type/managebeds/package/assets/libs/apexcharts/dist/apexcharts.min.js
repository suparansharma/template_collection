          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                (e.lastXAxis = JSON.parse(
                  JSON.stringify(e.initialConfig.xaxis)
                )),
                (e.lastYAxis = JSON.parse(
                  JSON.stringify(e.initialConfig.yaxis)
                )),
                e
              );
            },
            ...
            value: function () {
              ...
              (a += t.config.grid.padding.bottom),
                ("top" !== t.config.legend.position &&
                  ...
                  (i =
                    new ct(this.ctx).legendHelpers.getLegendBBox().clwh + 10);
              var s = t.globals.dom.baseEl.querySelector(
