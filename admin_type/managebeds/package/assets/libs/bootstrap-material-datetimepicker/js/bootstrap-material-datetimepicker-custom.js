  ...
  Plugin.prototype = {
    ...
    initTemplate: function () {
      ...
      var yearHtml =
        ...
        '<div><a href="javascript:void(0);" class="btn btn-default dtp-select-year-range before" style="margin: 0;"><i class="ri-arrow-up-s-line fs-4"></i></a></div>' +
        yearPicker +
        '<div><a href="javascript:void(0);" class="btn btn-default dtp-select-year-range after" style="margin: 0;"><i class="ri-arrow-down-s-line fs-4"></i></a></div>' +
        "</div>";
      ...
      this.template =
        ...
        '<div class="dtp-close"><a href="javascript:void(0);"><i class="ri-close-fill fs-4"></i></a></div>' +
        "</header>" +
        '<div class="dtp-date hidden">' +
        "<div>" +
        '<div class="left center p10">' +
        '<a href="javascript:void(0);" class="dtp-select-month-before"><i class="ri-arrow-left-s-line fs-4"></i></a>' +
        "</div>" +
        '<div class="dtp-actual-month p80">MAR</div>' +
        '<div class="right center p10">' +
        '<a href="javascript:void(0);" class="dtp-select-month-after"><i class="ri-arrow-right-s-line fs-4"></i></a>' +
        "</div>" +
        ...
        "<div>" +
        '<div class="left center p10">' +
        '<a href="javascript:void(0);" class="dtp-select-year-before"><i class="ri-arrow-left-s-line fs-4"></i></a>' +
        "</div>" +
        '<div class="dtp-actual-year p80' +
        (this.params.year ? "" : " disabled") +
        '">2014</div>' +
        '<div class="right center p10">' +
        '<a href="javascript:void(0);" class="dtp-select-year-after"><i class="ri-arrow-right-s-line fs-4"></i></a>' +
        "</div>" +
        '<div class="clearfix"></div>' +
        "</div>" +
        "</div>" +
        ...
        "</button>" +
        '<button class="dtp-btn-cancel btn btn-dark me-2">' +
        this.params.cancelText +
        "</button>" +
        '<button class="dtp-btn-ok btn btn-primary">' +
        this.params.okText +
        "</button>" +
        '<div class="clearfix"></div>' +
        "</div>" +
