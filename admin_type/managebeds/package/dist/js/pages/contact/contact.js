  ...
  function addContact() {
    $("#btn-add").click(function () {
      ...
      $html =
        ...
        '<img src="../assets/images/users/d1.jpg" alt="avatar" class="rounded-circle" width="50">' +
        '<div class="ms-3">' +
        '<div class="user-meta-info">' +
        '<h6 class="user-name mb-0 font-weight-medium" data-name=' +
        $_nameValue +
        ">" +
        $_nameValue +
        "</h6>" +
        '<small class="user-work text-muted" data-occupation=' +
        $_occupationValue +
        ">" +
        $_occupationValue +
        "</small>" +
